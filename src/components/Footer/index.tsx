...
export function Footer() {
  return (
    <footer className="bg-black pt-24 -z-[1]">
      <div className="mx-auto w-full max-w-[1170px] p-4 py-6 lg:py-8">
        <div className="md:flex">
          <div className="mb-6 md:mb-0 md:mr-40">
            <Link href="/" className="flex items-center mb-4">
              <Image src="/logowhite.svg" className="grayscale me-3" alt="KBusiness logo" width={80} height={80} />
            </Link>
          ...
          <div className="flex flex-col gap-8 sm:gap-24 sm:flex-row">
            <div>
              ...
              <ul className="text-white dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                  <Link href="#parcerias" className="hover:underline">
                    Parcerias
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-white dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                  <a href="#" className="hover:underline">
                    geral@kbusiness.co.ao
                  </a>
                </li>
                <li className="mb-4">
                  <p>Rua do 1º Congresso do MPLA, Edifício CIF LUANDA TWO, 9º Piso, Luanda - Angola</p>
                </li>
              </ul>
            </div>
          </div>
