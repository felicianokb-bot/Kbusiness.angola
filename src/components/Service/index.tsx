...
export function Service() {
  ...
  return (
    <section id="areas" className="py-16 md:py-24 lg:py-28 xl:py-32 bg-gray-200 bg-[url(/assets/backgroundservice.jpg)] bg-cover scroll-mt-24 animate-in fade-in slide-in-from-bottom-10 duration-500">
