      ...
      <div className="max-w-7xl px-8 w-full flex flex-col items-center mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-24">
          ...
          <div id="aprovisionamento-procurement" className="flex flex-col md:flex-row items-center gap-8 space-y-4 overflow-hidden">
            <div className="relative w-full md:w-1/2 bg-primary rounded-md overflow-hidden text-3xl mb-2 aspect-[16/9]">
              <Image src="/assets/banner2.jpg" alt="Aprovisionamento & Procurement" className="object-cover" fill sizes="(min-width:1024px) 50vw, 100vw" />
            </div>
            <div className="p-4">
              <h3 className="text-2xl uppercase mb-4 font-bold">
              ...
              <p className='mb-4 text-gray-700'>Na KBusiness, o aprovisionamento é encarado como uma função estratégica: não apenas de compra, mas de criação de valor, eficiência operacional e otimização de custos. Apoiamos empresas na identificação, aquisição e gestão de bens e serviços, com acesso a uma rede global de fornecedores e parceiros.</p>

              <div className="space-y-3 mb-6">
                <div>
                  <h4 className="font-bold text-base mb-1">• Fornecimento Estratégico</h4>
                  <p className="text-sm text-gray-600 ml-2">Levantamento de necessidades, qualificação de fornecedores, negociação de condições e estratégias ajustadas ao negócio</p>
                </div>

                <div>
                  <h4 className="font-bold text-base mb-1">• Procurement Global</h4>
                  <p className="text-sm text-gray-600 ml-2">Pesquisa internacional, comparação técnica e econômica, acesso a fabricantes globais e mitigação de riscos</p>
                </div>

                <div>
                  <h4 className="font-bold text-base mb-1">• Gestão da Cadeia de Abastecimento</h4>
                  <p className="text-sm text-gray-600 ml-2">Planeamento de compras, coordenação logística, monitorização de prazos e indicadores de gestão</p>
                </div>

                <div>
                  <h4 className="font-bold text-base mb-1">• Consolidação &amp; Central de Compras</h4>
                  <p className="text-sm text-gray-600 ml-2">Consolidação de necessidades, redução de complexidade e otimização de custos por escala</p>
                </div>
              </div>

              <div className="border-t pt-3 mt-3">
                <p className="text-sm font-semibold text-primary">Diferencial: Capacidade de sourcing global | Experiência em ambientes complexos | Foco em resultados práticos</p>
              </div>
            </div>
          </div>
        </div>
